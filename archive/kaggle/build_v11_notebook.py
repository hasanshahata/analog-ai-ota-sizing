 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Goal-Conditioned Analog AI Sizing (V11) - Kaggle Version\n",
    "V11 Features (Survival Bonus Fix):\n",
    "- Pure negative reward (no survival bonus exploit)\n",
    "- No early termination (agent endures all 200 steps)\n",
    "- Smooth normalized cost function from V11\n",
    "- Rich 15D Observation + Direct Parameter Output\n",
    "- Training: 500,000 steps\n",
    "\n",
    "## Data Sources\n",
    "1. **Code Dataset:** analog-ai-code-v11\n",
    "2. **LUT Source:** ota-rl-model-v9 kernel output"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "    if 'core' in dirs and 'circuits' in dirs and 'v11' in root.lower():\n",
    "        project_root = root\n",
    "        break\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    name_prefix='kaggle_ppo_model_v11'\n",
    ")"
   ]
  },
  {
   ...
   "source": [
    ...
    "\n",
    "# V11: Larger network (256x256) to handle the richer 15D observation space.\n",
    ...
    "\n",
    "print(\"Starting 500,000 Steps Training on Kaggle (V11 - Survival Bonus Fix)...\")\n",
    "model.learn(total_timesteps=500000, callback=checkpoint_callback)\n",
    "\n",
    "model_save_path = 'universal_ppo_agent_65nm_v11'\n",
...
with open(os.path.join("V11_Trainer", "Kaggle_Analog_RL_Trainer.ipynb"), 'w') as f:
    json.dump(notebook, f, indent=1)

print("V11 notebook built successfully!")
