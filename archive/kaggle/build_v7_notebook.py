 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Goal-Conditioned Analog AI Sizing (V7) - Kaggle Version\n",
    "V7 Features (The Flawless Run):\n",
    "- Mathematically Perfect 0-2000 Scaled Reward Function\n",
    "- Max NMOS Width: 250um\n",
    "- Max PMOS Width: 750um\n",
    "- Training: 500,000 steps\n",
    "\n",
    "## Setup Instructions\n",
    "1. **Upload Code:** Upload the `analog-ai-code-v7.zip` (from the V7_Trainer folder) as a Kaggle Dataset.\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    name_prefix='kaggle_ppo_model_v7'\n",
    ")"
   ]
  },
  {
   ...
   "source": [
    ...
    "\n",
    "# V7: We use a smaller learning rate and batch size for the perfectly scaled reward function to ensure extreme precision.\n",
    "model = PPO(\"MlpPolicy\", env, verbose=1, learning_rate=0.0003, batch_size=256, tensorboard_log=tb_log_dir)\n",
    "\n",
    "print(\"Starting 500,000 Steps Training on Kaggle (V7)...\")\n",
    "model.learn(total_timesteps=500000, callback=checkpoint_callback)\n",
    "\n",
    "final_model_path = os.path.join(WORKING_DIR, 'universal_ppo_agent_65nm_v7')\n",
...
with open('V7_Trainer/Kaggle_Analog_RL_Trainer.ipynb', 'w') as f:
