 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Goal-Conditioned Analog AI Sizing (V6) - Kaggle Version\n",
    "V6 Features:\n",
    "- Normalized Cliff Penalties (Prevents Gradient Explosion!)\n",
    "- Max NMOS Width: 250um\n",
    "- Max PMOS Width: 750um\n",
    "- Training: 500,000 steps\n",
    "\n",
    "## Setup Instructions\n",
    "1. **Upload Code:** Upload the `analog-ai-code-v6.zip` (from the V6_Trainer folder) as a Kaggle Dataset.\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    name_prefix='kaggle_ppo_model_v6'\n",
    ")"
   ]
  },
  {
   ...
   "source": [
    ...
    "\n",
    "print(\"Starting 500,000 Steps Training on Kaggle (V6)...\")\n",
    "model.learn(total_timesteps=500000, callback=checkpoint_callback)\n",
    "\n",
    "final_model_path = os.path.join(WORKING_DIR, 'universal_ppo_agent_65nm_v6')\n",
...
with open('V6_Trainer/Kaggle_Analog_RL_Trainer.ipynb', 'w') as f:
