 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Goal-Conditioned Analog AI Sizing (V2) - Kaggle Version\n",
    "This notebook downloads the LUT files directly from Google Drive.\n",
    "\n",
    "## Setup Instructions\n",
    "1. **Upload Code:** Upload the `analog-ai-code.zip` (from the V2_Trainer folder) as a Kaggle Dataset.\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "# Make sure to use IDs of FRESH COPIES if you get the 'Too many users' error!\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "print(\"Starting 500k Steps Training on Kaggle (V2)...\")\n",
    "model.learn(total_timesteps=500000, callback=checkpoint_callback)\n",
    "\n",
    "final_model_path = os.path.join(WORKING_DIR, 'universal_ppo_agent_65nm_v2')\n",
