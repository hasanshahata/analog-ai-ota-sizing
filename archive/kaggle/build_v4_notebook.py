 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Goal-Conditioned Analog AI Sizing (V4) - Kaggle Version\n",
    "V4 Features:\n",
    "- Max Length: 1.5um\n",
    "- Max Width: 150um (Hard Penalty)\n",
    "- Strict Power Enforcement (1000x Penalty)\n",
    "\n",
    "## Setup Instructions\n",
    "1. **Upload Code:** Upload the `analog-ai-code.zip` (from the V4_Trainer folder) as a Kaggle Dataset.\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    name_prefix='kaggle_ppo_model_v4'\n",
    ")"
   ]
  },
  {
   ...
   "source": [
    ...
    "\n",
    "print(\"Starting 500k Steps Training on Kaggle (V4)...\")\n",
    "model.learn(total_timesteps=500000, callback=checkpoint_callback)\n",
    "\n",
    "final_model_path = os.path.join(WORKING_DIR, 'universal_ppo_agent_65nm_v4')\n",
...
with open('V4_Trainer/Kaggle_Analog_RL_Trainer.ipynb', 'w') as f:
