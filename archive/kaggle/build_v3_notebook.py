 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Goal-Conditioned Analog AI Sizing (V3) - Kaggle Version\n",
    "This notebook trains V3 with expanded L limits (up to 1.5um) and CL targeting.\n",
    "\n",
    "## Setup Instructions\n",
    "1. **Upload Code:** Upload the `analog-ai-code.zip` (from the V3_Trainer folder) as a Kaggle Dataset.\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    name_prefix='kaggle_ppo_model_v3'\n",
    ")"
   ]
  },
  {
   ...
   "source": [
    ...
    "\n",
    "print(\"Starting 500k Steps Training on Kaggle (V3)...\")\n",
    "model.learn(total_timesteps=500000, callback=checkpoint_callback)\n",
    "\n",
    "final_model_path = os.path.join(WORKING_DIR, 'universal_ppo_agent_65nm_v3')\n",
...
with open('V3_Trainer/Kaggle_Analog_RL_Trainer.ipynb', 'w') as f:
