...
# Add V10_Trainer to the path so we can import its modules
sys.path.append(os.path.abspath("V10_Trainer"))
...
def test_v10_model():
    print("Initializing Physics Engine (V10)...")
    ...
    print("Loading Universal PPO Agent V10...")
    model_path = 'universal_ppo_agent_65nm_v10.zip'
    ...
    with open(os.path.join('Evaluation_Results', 'v10_evaluation_results.md'), 'w') as f:
        f.write(md)
    print("\nSaved results to Evaluation_Results/v10_evaluation_results.md")
