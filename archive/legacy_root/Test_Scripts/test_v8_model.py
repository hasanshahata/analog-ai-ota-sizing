...
def main():
    ...
    model = PPO.load("universal_ppo_agent_65nm_v8.zip")
    ...
    with open('v8_evaluation_results.md', 'w') as f:
        f.write(md)
    print("\nSaved results to v8_evaluation_results.md")
