...
def main():
    ...
    model = PPO.load("universal_ppo_agent_65nm_v9.zip")
    ...
    with open(os.path.join('Evaluation_Results', 'v9_evaluation_results.md'), 'w') as f:
        f.write(md)
    print("\nSaved results to Evaluation_Results/v9_evaluation_results.md")
