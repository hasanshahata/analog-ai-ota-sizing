...
def main():
    ...
    model = PPO.load("universal_ppo_agent_65nm_v4.zip")
    ...
    with open('v4_evaluation_results.md', 'w') as f:
        f.write(md)
    print("\nSaved results to v4_evaluation_results.md")
