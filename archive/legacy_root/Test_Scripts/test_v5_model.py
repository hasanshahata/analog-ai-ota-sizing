...
def main():
    ...
    model = PPO.load("universal_ppo_agent_65nm_v5.zip")
    ...
    with open('v5_evaluation_results.md', 'w') as f:
        f.write(md)
    print("\nSaved results to v5_evaluation_results.md")
