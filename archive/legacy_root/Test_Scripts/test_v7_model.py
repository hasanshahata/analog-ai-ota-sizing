...
def main():
    ...
    model = PPO.load("universal_ppo_agent_65nm_v7.zip")
    ...
    with open('v7_evaluation_results.md', 'w') as f:
        f.write(md)
    print("\nSaved results to v7_evaluation_results.md")
