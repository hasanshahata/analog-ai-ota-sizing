...
# Add V12_Trainer to the path so we can import its modules
sys.path.append(os.path.abspath("V12_Trainer"))
...
def test_V12_model():
    print("Initializing Physics Engine (V12)...")
    ...
    print("Loading Universal PPO Agent V12...")
    model_path = 'universal_ppo_agent_65nm_V12.zip'
    ...
    with open(os.path.join('Evaluation_Results', 'V12_evaluation_results.md'), 'w') as f:
        f.write(md)
    print("\nSaved results to Evaluation_Results/V12_evaluation_results.md")
