...
def main():
    ...
    model = PPO.load("universal_ppo_agent_65nm_v6.zip")
    ...
    with open('v6_evaluation_results.md', 'w') as f:
        f.write(md)
    print("\nSaved results to v6_evaluation_results.md")
